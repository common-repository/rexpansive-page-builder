...
var Overlay_Color_Section_Modal = (function($) {
  ...
  var _applyOverlay = function() {
    var status =
      true === background_overlay_properties.$overlay_active.prop("checked");
    var overlayData = {
  ...
  var _launchSpectrumOverlayColor = function() {
    ...
    background_overlay_properties.$overlay_color_palette_buttons.on(
      ...
      function(event) {
        ...
        background_overlay_properties.$overlay_color_preview_icon.hide();
        background_overlay_properties.$overlay_color_palette_buttons
    ...
    background_overlay_properties.$overlay_color_preview_icon.on(
      "click",
      function() {
  ...
  var _init = function($container) {
    background_overlay_properties = {
      ...
      $overlay_color_palette_buttons: $container.find(
        "#bg-overlay-row-color-palette .bg-palette-selector"
      )
    };
