...
(function () {
	...
	var onErrorCallback = function (event) {
		...
		if (queuing) {
			videoVisibleQueue.push(event.currentTarget);
			videoProcessingCounter--;
		}
	};
	...
	var handleIntersectionObserverSmart = function () {
		...
		scrollobserverSection = new IntersectionObserver(sectionIntersectionObserverCallback, {
			threshold: [0, 0.5, 1],
		...
		scrollobserverBlock = new IntersectionObserver(blockIntersectionObserverCallback, {
			threshold: [0, 0.5, 1],
			rootMargin: '100% 0% 100% 0%'
		});
